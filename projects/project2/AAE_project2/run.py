""" Course: Machine Learning
    Project 2: Satellite Images Road Segmentation
    Authors:
        - Maraz Erick
        - Montero Andres
        - Villarroel Adrian
...
FLAG_LOAD_WEIGTHS = False # Set this to False if you want to train again the model, we recomend using the jupyter notebook Project2_CNN_colab.ipynb on google colab, please review readme 
...
# If want to test with locally trained weigths change this to model.load("best_cnn.h5")
